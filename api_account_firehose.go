...
/*
AccountFirehoseApiService Get Fast Firehose Accounts at Bank
...
*/
func (a *AccountFirehoseApiService) GetFastFirehoseAccountsAtOneBank(ctx context.Context, bANKID string) (FastFirehoseAccountsJsonV400, *http.Response, error) {
	var (
...
/*
AccountFirehoseApiService Get Firehose Accounts at Bank
...
*/
func (a *AccountFirehoseApiService) GetFirehoseAccountsAtOneBank(ctx context.Context, vIEWID string, bANKID string) (ModeratedFirehoseAccountsJsonV400, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
AccountFirehoseApiService Get Firehose Transactions for Account
...
*/
func (a *AccountFirehoseApiService) GetFirehoseTransactionsForBankAccount(ctx context.Context, vIEWID string, aCCOUNTID string, bANKID string) (TransactionsJsonV300, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
