...
/*
EntitlementApiService Add Entitlement for a User
...
*/
func (a *EntitlementApiService) AddEntitlement(ctx context.Context, body CreateEntitlementJson, uSERID string) (EntitlementJson, *http.Response, error) {
	var (
...
/*
EntitlementApiService Create Entitlement Request for current User
...
*/
func (a *EntitlementApiService) AddEntitlementRequest(ctx context.Context, body CreateEntitlementJson) (EntitlementRequestJson, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
EntitlementApiService Create (DAuth) User with Roles
...
*/
func (a *EntitlementApiService) CreateUserWithRoles(ctx context.Context, body PostCreateUserWithRolesJsonV400) (EntitlementsJsonV400, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
EntitlementApiService Delete Entitlement
...
*/
func (a *EntitlementApiService) DeleteEntitlement(ctx context.Context, body EmptyClassJson, eNTITLEMENTID string, uSERID string) (EmptyClassJson, *http.Response, error) {
	var (
...
/*
EntitlementApiService Delete Entitlement Request
...
*/
func (a *EntitlementApiService) DeleteEntitlementRequest(ctx context.Context, eNTITLEMENTREQUESTID string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
EntitlementApiService Get all Entitlement Requests
&lt;p&gt;Get all Entitlement Requests&lt;/p&gt;&lt;p&gt;Authentication is Mandatory&lt;/p&gt;
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return EntitlementRequestsJson
*/
func (a *EntitlementApiService) GetAllEntitlementRequests(ctx context.Context) (EntitlementRequestsJson, *http.Response, error) {
	var (
...
/*
EntitlementApiService Get all Entitlements
...
*/
func (a *EntitlementApiService) GetAllEntitlements(ctx context.Context) (EntitlementJsons, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
EntitlementApiService Get Entitlement Requests for a User
...
@return EntitlementRequestsJson
*/
func (a *EntitlementApiService) GetEntitlementRequests(ctx context.Context, uSERID string) (EntitlementRequestsJson, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
EntitlementApiService Get Entitlement Requests for the current User
&lt;p&gt;Get Entitlement Requests for the current User.&lt;/p&gt;&lt;p&gt;Authentication is Mandatory&lt;/p&gt;
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return EntitlementRequestsJson
*/
func (a *EntitlementApiService) GetEntitlementRequestsForCurrentUser(ctx context.Context) (EntitlementRequestsJson, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
EntitlementApiService Get Entitlements for User
...
@return EntitlementsJsonV400
*/
func (a *EntitlementApiService) GetEntitlements(ctx context.Context, uSERID string) (EntitlementsJsonV400, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
EntitlementApiService Get Entitlements and Permissions for a User
&lt;p&gt;Authentication is Mandatory&lt;/p&gt;
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param uSERID The user id
...
@return UserJsonV300
*/
func (a *EntitlementApiService) GetEntitlementsAndPermissions(ctx context.Context, uSERID string) (UserJsonV300, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
EntitlementApiService Get Entitlements for User at Bank
...
@return EntitlementJsons
*/
func (a *EntitlementApiService) GetEntitlementsByBankAndUser(ctx context.Context, body EmptyClassJson, uSERID string, bANKID string) (EntitlementJsons, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
EntitlementApiService Get Entitlements for One Bank
&lt;p&gt;Authentication is Mandatory&lt;/p&gt;
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param bANKID The bank id
...
@return EntitlementsJsonV400
*/
func (a *EntitlementApiService) GetEntitlementsForBank(ctx context.Context, bANKID string) (EntitlementsJsonV400, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
EntitlementApiService Get Entitlements for the current User
&lt;p&gt;Get Entitlements for the current User.&lt;/p&gt;&lt;p&gt;Authentication is Mandatory&lt;/p&gt;
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return EntitlementJsons
*/
func (a *EntitlementApiService) GetEntitlementsForCurrentUser(ctx context.Context) (EntitlementJsons, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
EntitlementApiService Get access
...
*/
func (a *EntitlementApiService) GetPermissionsForBankAccount(ctx context.Context, body EmptyClassJson, aCCOUNTID string, bANKID string) (PermissionsJson, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
