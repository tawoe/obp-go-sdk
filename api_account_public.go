...
/*
AccountPublicApiService Get Public Account by Id
...
*/
func (a *AccountPublicApiService) GetPublicAccountById(ctx context.Context, vIEWID string, aCCOUNTID string, bANKID string) (ModeratedCoreAccountJsonV300, *http.Response, error) {
	var (
...
/*
AccountPublicApiService Get Public Accounts at all Banks
...
*/
func (a *AccountPublicApiService) PublicAccountsAllBanks(ctx context.Context, body EmptyClassJson) (BasicAccountsJson, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
AccountPublicApiService Get Public Accounts at Bank
...
@return BasicAccountsJson
*/
func (a *AccountPublicApiService) PublicAccountsAtOneBank(ctx context.Context, body EmptyClassJson, bANKID string) (BasicAccountsJson, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
