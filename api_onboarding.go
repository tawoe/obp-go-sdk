...
/*
OnboardingApiService Create Account (PUT)
...
*/
func (a *OnboardingApiService) CreateAccount(ctx context.Context, body CreateAccountRequestJsonV500, aCCOUNTID string, bANKID string) (CreateAccountResponseJsonV310, *http.Response, error) {
	var (
...
/*
OnboardingApiService Create User
...
@return UserJsonV200
*/
func (a *OnboardingApiService) CreateUser(ctx context.Context, body CreateUserJson) (UserJsonV200, *http.Response, error) {
	var (
