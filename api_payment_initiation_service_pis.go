...
/*
PaymentInitiationServicePISApiService Answer Transaction Request Challenge
...
*/
func (a *PaymentInitiationServicePISApiService) AnswerTransactionRequestChallenge(ctx context.Context, body ChallengeAnswerJson400, tRANSACTIONREQUESTID string, tRANSACTIONREQUESTTYPE string, vIEWID string, aCCOUNTID string, bANKID string) (TransactionRequestWithChargeJson210, *http.Response, error) {
	var (
...
/*
PaymentInitiationServicePISApiService Create Transaction Request (ACCOUNT)
...
*/
func (a *PaymentInitiationServicePISApiService) CreateTransactionRequestAccount(ctx context.Context, body TransactionRequestBodyJsonV200, vIEWID string, aCCOUNTID string, bANKID string) (TransactionRequestWithChargeJson400, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
PaymentInitiationServicePISApiService Create Transaction Request (ACCOUNT_OTP)
&lt;p&gt;When using ACCOUNT, the payee is set in the request body.&lt;/p&gt;&lt;p&gt;Money goes into the BANK_ID and ACCOUNT_ID specified in the request body.&lt;/p&gt;&lt;p&gt;Initiate a Payment via creating a Transaction Request.&lt;/p&gt;&lt;p&gt;In OBP, a &lt;code&gt;transaction request&lt;/code&gt; may or may not result in a &lt;code&gt;transaction&lt;/code&gt;. However, a &lt;code&gt;transaction&lt;/code&gt; only has one possible state: completed.&lt;/p&gt;&lt;p&gt;A &lt;code&gt;Transaction Request&lt;/code&gt; can have one of several states: INITIATED, NEXT_CHALLENGE_PENDING etc.&lt;/p&gt;&lt;p&gt;&lt;code&gt;Transactions&lt;/code&gt; are modeled on items in a bank statement that represent the movement of money.&lt;/p&gt;&lt;p&gt;&lt;code&gt;Transaction Requests&lt;/code&gt; are requests to move money which may or may not succeed and thus result in a &lt;code&gt;Transaction&lt;/code&gt;.&lt;/p&gt;&lt;p&gt;A &lt;code&gt;Transaction Request&lt;/code&gt; might create a security challenge that needs to be answered before the &lt;code&gt;Transaction Request&lt;/code&gt; proceeds.&lt;br /&gt;In case 1 person needs to answer security challenge we have next flow of state of an &lt;code&gt;transaction request&lt;/code&gt;:&lt;br /&gt;INITIATED &#x3D;&amp;gt; COMPLETED&lt;br /&gt;In case n persons needs to answer security challenge we have next flow of state of an &lt;code&gt;transaction request&lt;/code&gt;:&lt;br /&gt;INITIATED &#x3D;&amp;gt; NEXT_CHALLENGE_PENDING &#x3D;&amp;gt; ... &#x3D;&amp;gt; NEXT_CHALLENGE_PENDING &#x3D;&amp;gt; COMPLETED&lt;/p&gt;&lt;p&gt;The security challenge is bound to a user i.e. in case of right answer and the user is different than expected one the challenge will fail.&lt;/p&gt;&lt;p&gt;Rule for calculating number of security challenges:&lt;br /&gt;If product Account attribute REQUIRED_CHALLENGE_ANSWERS&#x3D;N then create N challenges&lt;br /&gt;(one for every user that has a View where permission &amp;quot;can_add_transaction_request_to_any_account&amp;quot;&#x3D;true)&lt;br /&gt;In case REQUIRED_CHALLENGE_ANSWERS is not defined as an account attribute default value is 1.&lt;/p&gt;&lt;p&gt;Transaction Requests contain charge information giving the client the opportunity to proceed or not (as long as the challenge level is appropriate).&lt;/p&gt;&lt;p&gt;Transaction Requests can have one of several Transaction Request Types which expect different bodies. The escaped body is returned in the details key of the GET response.&lt;br /&gt;This provides some commonality and one URL for many different payment or transfer types with enough flexibility to validate them differently.&lt;/p&gt;&lt;p&gt;The payer is set in the URL. Money comes out of the BANK_ID and ACCOUNT_ID specified in the URL.&lt;/p&gt;&lt;p&gt;In sandbox mode, TRANSACTION_REQUEST_TYPE is commonly set to ACCOUNT. See getTransactionRequestTypesSupportedByBank for all supported types.&lt;/p&gt;&lt;p&gt;In sandbox mode, if the amount is less than 1000 EUR (any currency, unless it is set differently on this server), the transaction request will create a transaction without a challenge, else the Transaction Request will be set to INITIALISED and a challenge will need to be answered.&lt;/p&gt;&lt;p&gt;If a challenge is created you must answer it using Answer Transaction Request Challenge before the Transaction is created.&lt;/p&gt;&lt;p&gt;You can transfer between different currency accounts. (new in 2.0.0). The currency in body must match the sending account.&lt;/p&gt;&lt;p&gt;The following static FX rates are available in sandbox mode:&lt;/p&gt;&lt;p&gt;&lt;a href&#x3D;\&quot;https://test-explorer.openbankproject.com/more?version&#x3D;OBPv4.0.0&amp;amp;list-all-banks&#x3D;false&amp;amp;core&#x3D;&amp;amp;psd2&#x3D;&amp;amp;obwg&#x3D;#OBPv2_2_0-getCurrentFxRate\&quot;&gt;https://test-explorer.openbankproject.com/more?version&#x3D;OBPv4.0.0&amp;amp;list-all-banks&#x3D;false&amp;amp;core&#x3D;&amp;amp;psd2&#x3D;&amp;amp;obwg&#x3D;#OBPv2_2_0-getCurrentFxRate&lt;/a&gt;&lt;/p&gt;&lt;p&gt;Transaction Requests satisfy PSD2 requirements thus:&lt;/p&gt;&lt;p&gt;1) A transaction can be initiated by a third party application.&lt;/p&gt;&lt;p&gt;2) The customer is informed of the charge that will incurred.&lt;/p&gt;&lt;p&gt;3) The call supports delegated authentication (OAuth)&lt;/p&gt;&lt;p&gt;See &lt;a href&#x3D;\&quot;https://github.com/OpenBankProject/Hello-OBP-DirectLogin-Python/blob/master/hello_payments.py\&quot;&gt;this python code&lt;/a&gt; for a complete example of this flow.&lt;/p&gt;&lt;p&gt;There is further documentation &lt;a href&#x3D;\&quot;https://github.com/OpenBankProject/OBP-API/wiki/Transaction-Requests\&quot;&gt;here&lt;/a&gt;&lt;/p&gt;&lt;p&gt;Authentication is Mandatory&lt;/p&gt;
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param body TransactionRequestBodyJsonV200 object that needs to be added.
  - @param vIEWID The view id
...
@return TransactionRequestWithChargeJson400
*/
func (a *PaymentInitiationServicePISApiService) CreateTransactionRequestAccountOtp(ctx context.Context, body TransactionRequestBodyJsonV200, vIEWID string, aCCOUNTID string, bANKID string) (TransactionRequestWithChargeJson400, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
PaymentInitiationServicePISApiService Create Transaction Request (CARD)
...
@return TransactionRequestWithChargeJson400
*/
func (a *PaymentInitiationServicePISApiService) CreateTransactionRequestCard(ctx context.Context, body TransactionRequestBodyCardJsonV400) (TransactionRequestWithChargeJson400, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
PaymentInitiationServicePISApiService Create Transaction Request (COUNTERPARTY)
...
@return TransactionRequestWithChargeJson400
*/
func (a *PaymentInitiationServicePISApiService) CreateTransactionRequestCounterparty(ctx context.Context, body TransactionRequestBodyCounterpartyJson, vIEWID string, aCCOUNTID string, bANKID string) (TransactionRequestWithChargeJson400, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
PaymentInitiationServicePISApiService Create Transaction Request (FREE_FORM)
...
@return TransactionRequestWithChargeJson400
*/
func (a *PaymentInitiationServicePISApiService) CreateTransactionRequestFreeForm(ctx context.Context, body TransactionRequestBodyFreeFormJson, vIEWID string, aCCOUNTID string, bANKID string) (TransactionRequestWithChargeJson400, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
PaymentInitiationServicePISApiService Create Transaction Request (REFUND)
...
@return TransactionRequestWithChargeJson400
*/
func (a *PaymentInitiationServicePISApiService) CreateTransactionRequestRefund(ctx context.Context, body TransactionRequestBodyRefundJsonV400, vIEWID string, aCCOUNTID string, bANKID string) (TransactionRequestWithChargeJson400, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
PaymentInitiationServicePISApiService Create Transaction Request (SANDBOX_TAN)
...
@return TransactionRequestWithChargeJson210
*/
func (a *PaymentInitiationServicePISApiService) CreateTransactionRequestSandboxTan(ctx context.Context, body TransactionRequestBodyJsonV200, vIEWID string, aCCOUNTID string, bANKID string) (TransactionRequestWithChargeJson210, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
PaymentInitiationServicePISApiService Create Transaction Request (SEPA)
...
@return TransactionRequestWithChargeJson400
*/
func (a *PaymentInitiationServicePISApiService) CreateTransactionRequestSepa(ctx context.Context, body TransactionRequestBodySepaJsonV400, vIEWID string, aCCOUNTID string, bANKID string) (TransactionRequestWithChargeJson400, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
PaymentInitiationServicePISApiService Create Transaction Request (SIMPLE)
...
@return TransactionRequestWithChargeJson400
*/
func (a *PaymentInitiationServicePISApiService) CreateTransactionRequestSimple(ctx context.Context, body TransactionRequestBodySimpleJsonV400, vIEWID string, aCCOUNTID string, bANKID string) (TransactionRequestWithChargeJson400, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
PaymentInitiationServicePISApiService Get Counterparties for any account (Explicit)
...
*/
func (a *PaymentInitiationServicePISApiService) GetCounterpartiesForAnyAccount(ctx context.Context, vIEWID string, aCCOUNTID string, bANKID string) (CounterpartiesJson400, *http.Response, error) {
	var (
...
/*
PaymentInitiationServicePISApiService Get Counterparties (Explicit)
...
@return CounterpartiesJson400
*/
func (a *PaymentInitiationServicePISApiService) GetExplictCounterpartiesForAccount(ctx context.Context, vIEWID string, aCCOUNTID string, bANKID string) (CounterpartiesJson400, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
PaymentInitiationServicePISApiService Get Counterparty by Id (Explicit)
...
*/
func (a *PaymentInitiationServicePISApiService) GetExplictCounterpartyById(ctx context.Context, cOUNTERPARTYID string, vIEWID string, aCCOUNTID string, bANKID string) (CounterpartyWithMetadataJson400, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
PaymentInitiationServicePISApiService Get Transaction Request.
...
@return TransactionRequestWithChargeJson210
*/
func (a *PaymentInitiationServicePISApiService) GetTransactionRequest(ctx context.Context, tRANSACTIONREQUESTID string, vIEWID string, aCCOUNTID string, bANKID string) (TransactionRequestWithChargeJson210, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
PaymentInitiationServicePISApiService Get Transaction Request Types for Account
...
*/
func (a *PaymentInitiationServicePISApiService) GetTransactionRequestTypes(ctx context.Context, body EmptyClassJson, vIEWID string, aCCOUNTID string, bANKID string) (TransactionRequestTypesJsonV140, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
PaymentInitiationServicePISApiService Get Transaction Requests.
...
*/
func (a *PaymentInitiationServicePISApiService) GetTransactionRequests(ctx context.Context, vIEWID string, aCCOUNTID string, bANKID string) (TransactionRequestWithChargeJsons210, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
