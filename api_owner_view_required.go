...
/*
OwnerViewRequiredApiService Create (DAuth) User with Account Access
...
*/
func (a *OwnerViewRequiredApiService) CreateUserWithAccountAccess(ctx context.Context, body PostCreateUserAccountAccessJsonV400, aCCOUNTID string, bANKID string) (NotSupportedYet, *http.Response, error) {
	var (
...
/*
OwnerViewRequiredApiService Grant User access to View
...
@return ViewJsonV300
*/
func (a *OwnerViewRequiredApiService) GrantUserAccessToView(ctx context.Context, body PostAccountAccessJsonV400, aCCOUNTID string, bANKID string) (ViewJsonV300, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
OwnerViewRequiredApiService Revoke/Grant User access to View
...
*/
func (a *OwnerViewRequiredApiService) RevokeGrantUserAccessToViews(ctx context.Context, body PostRevokeGrantAccountAccessJsonV400, aCCOUNTID string, bANKID string) (RevokedJsonV400, *http.Response, error) {
	var (
...
/*
OwnerViewRequiredApiService Revoke User access to View
...
@return RevokedJsonV400
*/
func (a *OwnerViewRequiredApiService) RevokeUserAccessToView(ctx context.Context, body PostAccountAccessJsonV400, aCCOUNTID string, bANKID string) (RevokedJsonV400, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
