...
type DynamicEndpointApiService service

/*
DynamicEndpointApiService Get Bank Account By Id
...
*/
func (a *DynamicEndpointApiService) DynamicEndpointGETAccountsACCOUNTID(ctx context.Context, aCCOUNTID string) (InlineResponse2012, *http.Response, error) {
	var (
...
/*
DynamicEndpointApiService Post Accounts
...
@return InlineResponse2012
*/
func (a *DynamicEndpointApiService) DynamicEndpointPOSTAccounts(ctx context.Context) (InlineResponse2012, *http.Response, error) {
	var (
