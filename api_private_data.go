...
/*
PrivateDataApiService Get Accounts at all Banks (private)
...
*/
func (a *PrivateDataApiService) CorePrivateAccountsAllBanks(ctx context.Context) (CoreAccountsJsonV300, *http.Response, error) {
	var (
...
/*
PrivateDataApiService Get Accounts at Bank
...
*/
func (a *PrivateDataApiService) GetPrivateAccountsAtOneBank(ctx context.Context, bANKID string) (BasicAccountsJson, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
