...
/*
ExperimentalApiService Create Meeting (video conference/call)
...
*/
func (a *ExperimentalApiService) CreateMeeting(ctx context.Context, body CreateMeetingJsonV310, bANKID string) (MeetingJsonV310, *http.Response, error) {
	var (
...
/*
ExperimentalApiService Get Meeting
...
@return MeetingJsonV310
*/
func (a *ExperimentalApiService) GetMeeting(ctx context.Context, mEETINGID string, bANKID string) (MeetingJsonV310, *http.Response, error) {
	var (
...
/*
ExperimentalApiService Get Meetings
...
*/
func (a *ExperimentalApiService) GetMeetings(ctx context.Context, bANKID string) (MeetingsJsonV310, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
