...
/*
TransactionFirehoseApiService Get Firehose Transactions for Account
...
*/
func (a *TransactionFirehoseApiService) GetFirehoseTransactionsForBankAccount(ctx context.Context, vIEWID string, aCCOUNTID string, bANKID string) (TransactionsJsonV300, *http.Response, error) {
	var (
