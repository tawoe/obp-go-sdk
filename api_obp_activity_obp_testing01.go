...
type ObpActivityObpTesting01ApiService service

/*
ObpActivityObpTesting01ApiService Create new Obp Activity
...
*/
func (a *ObpActivityObpTesting01ApiService) DynamicEntityCreateObpActivityObpTesting01(ctx context.Context, body Body33) (InlineResponse20022ObpActivityList, *http.Response, error) {
	var (
...
/*
ObpActivityObpTesting01ApiService Delete Obp Activity by id
...
@return InlineResponse20022ObpActivityList
*/
func (a *ObpActivityObpTesting01ApiService) DynamicEntityDeleteObpActivityObpTesting01(ctx context.Context, body Body35) (InlineResponse20022ObpActivityList, *http.Response, error) {
	var (
...
/*
ObpActivityObpTesting01ApiService Get Obp Activity List
...
*/
func (a *ObpActivityObpTesting01ApiService) DynamicEntityGetObpActivityListObpTesting01(ctx context.Context) (InlineResponse20022, *http.Response, error) {
	var (
...
/*
ObpActivityObpTesting01ApiService Get Obp Activity by id
&lt;p&gt;Get Obp Activity by id.&lt;/p&gt;&lt;p&gt;Description of this entity, can be markdown text.&lt;/p&gt;&lt;p&gt;&lt;strong&gt;Property List:&lt;/strong&gt;&lt;/p&gt;&lt;ul&gt;&lt;li&gt;name: description of &lt;strong&gt;name&lt;/strong&gt; field, can be markdown text.&lt;/li&gt;&lt;li&gt;username: description of &lt;strong&gt;name&lt;/strong&gt; field, can be markdown text.&lt;/li&gt;&lt;li&gt;created_date: description of &lt;strong&gt;number&lt;/strong&gt; field, can be markdown text.&lt;/li&gt;&lt;/ul&gt;&lt;p&gt;MethodRouting settings example:&lt;/p&gt;&lt;details&gt;&lt;pre&gt;&lt;code&gt;{  &amp;quot;is_bank_id_exact_match&amp;quot;:false,  &amp;quot;method_name&amp;quot;:&amp;quot;dynamicEntityProcess&amp;quot;,  &amp;quot;connector_name&amp;quot;:&amp;quot;rest_vMar2019&amp;quot;,  &amp;quot;bank_id_pattern&amp;quot;:&amp;quot;.*&amp;quot;,  &amp;quot;parameters&amp;quot;:[    {        &amp;quot;key&amp;quot;:&amp;quot;entityName&amp;quot;,        &amp;quot;value&amp;quot;:&amp;quot;ObpActivity&amp;quot;    }    {        &amp;quot;key&amp;quot;:&amp;quot;url&amp;quot;,        &amp;quot;value&amp;quot;:&amp;quot;http://mydomain.com/xxx&amp;quot;    }  ]}&lt;/code&gt;&lt;/pre&gt;&lt;/details&gt;&lt;p&gt;Authentication is Mandatory&lt;/p&gt;
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return InlineResponse20022ObpActivityList
*/
func (a *ObpActivityObpTesting01ApiService) DynamicEntityGetSingleObpActivityObpTesting01(ctx context.Context) (InlineResponse20022ObpActivityList, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
ObpActivityObpTesting01ApiService Update Obp Activity
...
@return InlineResponse20022ObpActivityList
*/
func (a *ObpActivityObpTesting01ApiService) DynamicEntityUpdateObpActivityObpTesting01(ctx context.Context, body Body34) (InlineResponse20022ObpActivityList, *http.Response, error) {
	var (
