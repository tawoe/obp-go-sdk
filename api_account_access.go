...
/*
AccountAccessApiService Create (DAuth) User with Account Access
...
*/
func (a *AccountAccessApiService) CreateUserWithAccountAccess(ctx context.Context, body PostCreateUserAccountAccessJsonV400, aCCOUNTID string, bANKID string) (NotSupportedYet, *http.Response, error) {
	var (
...
/*
AccountAccessApiService Grant User access to View
...
@return ViewJsonV300
*/
func (a *AccountAccessApiService) GrantUserAccessToView(ctx context.Context, body PostAccountAccessJsonV400, aCCOUNTID string, bANKID string) (ViewJsonV300, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
AccountAccessApiService Revoke/Grant User access to View
...
*/
func (a *AccountAccessApiService) RevokeGrantUserAccessToViews(ctx context.Context, body PostRevokeGrantAccountAccessJsonV400, aCCOUNTID string, bANKID string) (RevokedJsonV400, *http.Response, error) {
	var (
...
/*
AccountAccessApiService Revoke User access to View
...
@return RevokedJsonV400
*/
func (a *AccountAccessApiService) RevokeUserAccessToView(ctx context.Context, body PostAccountAccessJsonV400, aCCOUNTID string, bANKID string) (RevokedJsonV400, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
